<template>
    <div>
        ...
        >
            ...
            >
                <span class="inline-block"
                    >ขายสติกเกอร์ไลน์ลิขสิทธิ์ของแท้ ไม่หมดอายุ
                    มีเครดิตเชื่อถือได้ 100%
                    เป็นร้านค้าที่ได้รับอนุญาตอย่างเป็นทางการจากทางไลน์
                    (Verified Resellers) เปิดร้านขายมากว่า 12 ปี</span
                >
            </p>
        </div>
